...
class _LoginFormState extends State<LoginForm> {
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () => _loginProcessor(loginController.value.text, passwordController.value.text),
  ...
  _loginProcessor(String email, String password) {
    ...
    if (_formKey.currentState!.validate()) {
      Provider.of<AuthenticationStore>(context, listen: false).logIn(email, password);
    }
  }
}
